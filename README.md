...
> _Homepage — animated hero with interactive JVM diagram_

![InsideJVM Homepage](./docs/screenshots/home.png)

> _JVM Architecture — clickable React Flow diagram with side panel_

![JVM Architecture Page](./docs/screenshots/architecture.png)

> _Garbage Collection — 4 algorithms with live heap simulation_

![Garbage Collection Page](./docs/screenshots/gc.png)
