...
import {
  ...
  MessageSquare, ChevronRight, Star, Code2, BookOpen, Play, SlidersHorizontal, Workflow, Activity, Droplets,
} from 'lucide-react';
...
const iconMap: Record<string, React.ElementType> = {
  Cpu, Layers, Package, Zap, Trash2, GitBranch, Shield, MessageSquare, Play, Code2, SlidersHorizontal, Workflow, Activity, Droplets,
};
